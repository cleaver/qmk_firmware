...
[_LOWER] = LAYOUT_preonic_2x2u(
  ...
  KC_TILD, _______, KC_7,    KC_8,    KC_9,    _______, CB_RA,   CB_LA,      CB_BA,      KC_LBRC, KC_RBRC, CB_EXP,
  KC_DEL,  CB_TL,   KC_4,    KC_5,    KC_6,    CB_TR,   _______, KC_MINS,    KC_EQL,     KC_LCBR, KC_RCBR, KC_BSLS,
  KC_CAPS, KC_0,    KC_1,    KC_2,    KC_3,    KC_DOT,  _______, S(KC_NUHS), S(KC_NUBS), KC_HOME, KC_END,  _______,
