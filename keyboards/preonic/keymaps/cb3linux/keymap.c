...
enum preonic_keycodes {
  ...
  CB_BA,    // big arrow (=>)
  CB_EXP,   // elixir pipe (|>)
  CB_LW,    // left word (ctrl + left)
  CB_RW,    // right word (ctrl + right)
  CB_SLW,   // select left word (shift + ctrl + left)
  CB_SRW,   // select right word (shift + ctrl + right)
...
[_COLEMAK] = LAYOUT_preonic_2x2u(
  ...
  CB_NUM,    KC_LCTL, KC_LALT, KC_LGUI, LT(_LOWER, KC_SPC), LT(_RAISE, KC_SPC), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_NAV] = LAYOUT_preonic_2x2u(
  ...
  _______, _______, CB_MLDN, CB_MLUP, _______, _______, _______, KC_HOME, CB_LW,   CB_RW,   KC_END,  KC_DEL,
  _______, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,
  _______, _______, CB_CLDN, CB_CLUP, _______, _______, _______, KC_PGUP, CB_SLW,  CB_SRW,  KC_PGDN, KC_ENT,
...
[_NUM] = LAYOUT_preonic_2x2u(
  ...
  _______, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, _______, KC_COLN, KC_4,    KC_5,    KC_6,    KC_PMNS, KC_PERC,
  _______, _______, CB_CLDN, CB_CLUP, _______, _______, _______, KC_1,    KC_2,    KC_3,    KC_PSLS, KC_ENT,
  _______, _______, _______, _______, _______,          KC_0,             KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
